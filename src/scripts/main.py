...
def main(raw_args=None):
    ...
    META_GLOB="human_metadata_1.pkl"
    EXPR_GLOB="human_counts_1.npz" 
    ...
    META_FIELDS_VOCABS_FILE_NAME="metadata_vocab_assay.json"
    FIELD_SPECS_FILE_NAME="metadata_field_specs_assay.json"
